...
\title{\huge{\textbf{The Development of AI in Game Playing Area}}}
...
\input{background}
\input{Related}
\input{GoogleAlphaGoTechnicalDetails}

\section{Goals}
This project will summarize different aspects of game-playing AI. Through this project, the participant will acquire a deep understanding of the related techniques, this project will include the following work:
\subsection{Review of research background}
\begin{enumerate}
	\item Game-playing AI research;
	\item Compute capability change in recent years.
\end{enumerate}
\subsection{Related readings}
\begin{enumerate}
	\item Rule based; 
	\item Monte-Carlo method;
	\item Deep neural network.~\cite{silver2016mastering, tian2015better, coulom2007computing}
\end{enumerate}
\subsection{General understanding of the following techniques}
\begin{enumerate}
	\item Deap neural network; 
	\item Pattern recognition;
	\item Rule based game playing;
\end{enumerate}
\subsection{Review the algorithms}
...
\begin{figure}[t]
\centering
%\includegraphics[width=3in]{New01TestProcedure.pdf}
